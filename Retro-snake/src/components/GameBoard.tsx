...
export const GameBoard: React.FC<GameBoardProps> = ({
  ...
  useEffect(() => {
    ...
    if (food) {
      ...
      if (food.type === 'golden') {
        ...
        ctx.beginPath();
        ctx.roundRect(fx - radius, fy - radius, radius * 2, radius * 2, 4);
        ctx.fill();
  ...
  return (
    <div id="game-canvas-wrapper" className="relative w-full max-w-[480px] aspect-square mx-auto rounded-2xl overflow-hidden shadow-[0_0_30px_rgba(6,182,212,0.25)] border-4 border-cyan-500/80 bg-black flex items-center justify-center">
      <canvas
        id="snake-canvas"
        ref={canvasRef}
        width={480}
      ...
      {!hasGameStarted && !isGameOver && countdown === null && (
        <div id="start-screen-overlay" className="absolute inset-0 bg-black/85 backdrop-blur-xs flex flex-col items-center justify-center text-white z-20 p-6 text-center animate-fadeIn">
      ...
      {countdown !== null && (
        <div id="countdown-overlay" className="absolute inset-0 bg-black/85 backdrop-blur-xs flex flex-col items-center justify-center text-white z-20 select-none animate-fadeIn">
      ...
      {isPaused && !isGameOver && hasGameStarted && countdown === null && (
        <div id="pause-overlay" className="absolute inset-0 bg-black/80 backdrop-blur-xs flex flex-col items-center justify-center text-white z-10 transition-all">
